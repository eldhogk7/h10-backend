...
-- CreateEnum
CREATE TYPE "PodLifecycleStatus" AS ENUM ('ACTIVE', 'ASSIGNED', 'DAMAGED', 'LOST', 'REPLACED', 'MAINTENANCE', 'RETIRED', 'REPAIRED', 'SCRAP');
...
CREATE TABLE "team_thresholds" (
    ...
    CONSTRAINT "team_thresholds_pkey" PRIMARY KEY ("threshold_id")
);

-- CreateTable
CREATE TABLE "exercise_types" (
    "exercise_type_id" UUID NOT NULL,
    "exrId" CHAR(5) NOT NULL ,
    "club_id" UUID NOT NULL,
    "name" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "player_thresholds" (
    "threshold_id" UUID NOT NULL,
    "player_id" UUID NOT NULL,
    "type" TEXT NOT NULL,
    "zone_name" TEXT NOT NULL,
    ...
    CONSTRAINT "player_thresholds_pkey" PRIMARY KEY ("threshold_id")
);
...
-- CreateTable
CREATE TABLE "club_hr_zone_defaults" (
    "zone_id" UUID NOT NULL,
    "club_id" UUID NOT NULL,
    "zone_number" INTEGER NOT NULL,
    "min_hr" INTEGER NOT NULL,
    ...
    CONSTRAINT "club_hr_zone_defaults_pkey" PRIMARY KEY ("zone_id")
);
...
CREATE TABLE "events" (
    ...
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "file_end_ts" BIGINT,
    "file_start_ts" BIGINT,
    "session_id" TEXT,
    "trim_end_ts" BIGINT,
    "trim_start_ts" BIGINT,
    "ground_name" TEXT,
    "notes" TEXT,
...
-- CreateTable
CREATE TABLE "exercise_players" (
    "id" UUID NOT NULL,
    "exercise_id" UUID NOT NULL,
    "player_id" UUID NOT NULL,

    CONSTRAINT "exercise_players_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "team_thresholds_club_id_type_zone_name_key" ON "team_thresholds"("club_id", "type", "zone_name");

-- CreateIndex
CREATE UNIQUE INDEX "exercise_types_exrId_key" ON "exercise_types"("exrId");
...
-- CreateIndex
CREATE UNIQUE INDEX "player_thresholds_player_id_type_zone_name_key" ON "player_thresholds"("player_id", "type", "zone_name");

-- CreateIndex
CREATE UNIQUE INDEX "hr_zones_player_id_zone_number_key" ON "hr_zones"("player_id", "zone_number");

-- CreateIndex
CREATE UNIQUE INDEX "club_hr_zone_defaults_club_id_zone_number_key" ON "club_hr_zone_defaults"("club_id", "zone_number");
...
-- CreateIndex
CREATE INDEX "exercises_exrId_idx" ON "exercises"("exrId");

-- CreateIndex
CREATE UNIQUE INDEX "exercise_players_exercise_id_player_id_key" ON "exercise_players"("exercise_id", "player_id");
...
-- CreateIndex
CREATE INDEX "activity_metrics_session_id_exrId_idx" ON "activity_metrics"("session_id", "exrId");

-- CreateIndex
CREATE UNIQUE INDEX "activity_metrics_session_id_player_id_exrId_key" ON "activity_metrics"("session_id", "player_id", "exrId");
...
-- AddForeignKey
ALTER TABLE "team_thresholds" ADD CONSTRAINT "team_thresholds_club_id_fkey" FOREIGN KEY ("club_id") REFERENCES "clubs"("club_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "player_thresholds" ADD CONSTRAINT "player_thresholds_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "players"("player_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "club_hr_zone_defaults" ADD CONSTRAINT "club_hr_zone_defaults_club_id_fkey" FOREIGN KEY ("club_id") REFERENCES "clubs"("club_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "coach_assignments" ADD CONSTRAINT "coach_assignments_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "players"("player_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "raw_data" ADD CONSTRAINT "raw_data_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "players"("player_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "exercises" ADD CONSTRAINT "exercises_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "events"("event_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exercises" ADD CONSTRAINT "exercises_exrId_fkey" FOREIGN KEY ("exrId") REFERENCES "exercise_types"("exrId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exercise_players" ADD CONSTRAINT "exercise_players_exercise_id_fkey" FOREIGN KEY ("exercise_id") REFERENCES "exercises"("exercise_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exercise_players" ADD CONSTRAINT "exercise_players_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "players"("player_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "event_participants" ADD CONSTRAINT "event_participants_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "players"("player_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "activity_metrics" ADD CONSTRAINT "activity_metrics_exrId_fkey" FOREIGN KEY ("exrId") REFERENCES "exercise_types"("exrId") ON DELETE SET NULL ON UPDATE CASCADE;
